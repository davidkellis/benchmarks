// Taken from https://github.com/kostya/benchmarks/blob/master/brainfuck2/bf.cs
...
namespace Test
{
    enum OpT {INC, MOVE, INPUT, PRINT, LOOP};
    ...
    public class Tape
    {
        ...
        public void Set(int x) { tape[pos] = x; }
        ...
        private Op[] parse() {
            ...
            while (pos < code.Length) {                
                ...
                switch (c) {
                    ...
                    case '<': res.Add(new Op(OpT.MOVE, -1)); break;
                    case 'i': res.Add(new Op(OpT.INPUT, 0)); break;
                    case 'o': res.Add(new Op(OpT.PRINT, 0)); break;
