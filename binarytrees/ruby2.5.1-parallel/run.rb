# Taken from https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/binarytrees-yarv-5.html
...
module MiniParallel
    ...
    def self.core_count
        @@core_count ||= 4 || IO.read("/proc/cpuinfo").scan(/^processor/).size
    end
